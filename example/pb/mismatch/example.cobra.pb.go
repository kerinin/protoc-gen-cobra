...
var _DefaultServiceClientCommandConfig = _NewServiceClientCommandConfig()

type _ServiceClientCommandConfig struct {
...
func _NewServiceClientCommandConfig() *_ServiceClientCommandConfig {
	c := &_ServiceClientCommandConfig{}
	envconfig.Process("", c)
	return c
}

func (o *_ServiceClientCommandConfig) AddFlags(fs *pflag.FlagSet) {
...
var ServiceClientCommand = &cobra.Command{
	Use: "service",
}

func _DialService() (*grpc.ClientConn, ServiceClient, error) {
	cfg := _DefaultServiceClientCommandConfig
	...
	return conn, NewServiceClient(conn), nil
}

type _ServiceRoundTripFunc func(cli ServiceClient, in iocodec.Decoder, out iocodec.Encoder) error

func _ServiceRoundTrip(sample interface{}, fn _ServiceRoundTripFunc) error {
	cfg := _DefaultServiceClientCommandConfig
...
var _ServiceMethodClientCommand = &cobra.Command{
	Use:  "method",
...
Authenticate using the Authorization header (requires transport security):
	...
	echo '{json}' | method --tls`,
	Run: func(cmd *cobra.Command, args []string) {
		var v Input
		err := _ServiceRoundTrip(v, func(cli ServiceClient, in iocodec.Decoder, out iocodec.Encoder) error {
...
func init() {
	ServiceClientCommand.AddCommand(_ServiceMethodClientCommand)
	_DefaultServiceClientCommandConfig.AddFlags(_ServiceMethodClientCommand.Flags())
}
